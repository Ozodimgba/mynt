...
export async function mintOneCNFT(creators: string[]) {
  //////////////////////////////////////////////////////////////////////////////
  //////////////////////////////////////////////////////////////////////////////
  ...
  const creator: PublicKey[] = creators.map(
    (creatorString) => new PublicKey(creatorString),
  );
  ...
  */
  ...
  console.log(treeKeypair.publicKey);
...
const creators = [
  '4g7CLQdNUckRi28FgMgZf4aKExrufBBVYVgJ2i3cLXBP',
  '8Hs2MzJAuWXt57LKcTsYQaRCZyNUeuyuGHrfAzYQSLDv',
];

mintOneCNFT(creators);
